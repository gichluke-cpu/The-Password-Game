...
def show_exit_dialog():
    ...
    f.pack()
    tk.Button(f, text="▶️ Return to Game", width=18, command=lambda: [dlg.destroy(), continue_timer()], bg="#a3d9a5").grid(row=0, column=0, padx=5)
    ...
    dlg.protocol("WM_DELETE_WINDOW", lambda: [dlg.destroy(), continue_timer()])
